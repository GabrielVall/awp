    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row align-items-center mb-2">
                <div class="col">
                    <h2 class="h3 page-title">Agregar nueva área de servicio</h2>
                </div>
                <div class="col-auto">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb bg-light">
                            <li class="breadcrumb-item"><a href="#areas_servicio" class="text-decoration-none text-muted">Áreas de servicio</a></li>
                            <li class="breadcrumb-item"><a href="#nueva_area_servicio" class="text-decoration-none text-muted">Nueva área de servicio</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card shadow">
                        <div class="card-header">
                            <strong class="card-title">Nueva área de servicio</strong>
                        </div>
                        <div class="card-body">
                            <div class="row" id="content_info">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm name_format" id="nombre_zona">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label class="form-label">Radio</label>
                                        <input type="text" class="form-control form-control-sm price_format" id="radio_zona">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="" data-limit="2000" id="direccion_zona">
                                        <input type="hidden" id="lat_zona" value="0">
                                        <input type="hidden" id="lon_zona" value="0">
                                        <div id="mapa_zona" style="height:300px; display: none; margin: auto; "></div>
                                    </div>
                                    <div class="form-group text-right">
                                        <button class="btn btn-outline-dark" id="btn_agregar_zona">Agregar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
