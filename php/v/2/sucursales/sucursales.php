...
$row_sucursales = $sql->obtenerResultado("CALL sp_select_sucursales1();");
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row align-items-center mb-2">
                <div class="col">
                    <h2 class="h3 page-title">Sucursales</h2>
                </div>
                <div class="col-auto">
                    <a href="#nueva_sucursal" class="btn btn-dark">Agregar sucursal</a>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
