...
$total_ordenes_productos = count($row_ordenes_productos);
	...
	// INFO ENCABEZADO DETALLE ORDEN
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A8', 'Teléfono:')->getStyle('A8')->applyFromArray(fontsize(10,true));
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A13', 'Dirección de remitente')->getStyle('A13')->applyFromArray(fontsize(10,true));

        $objPHPExcel->setActiveSheetIndex(0)->mergeCells("A16:C16");
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A16', 'Dirección de destinatario')->getStyle('A16')->applyFromArray(fontsize(10,true));
